...
------------- | ------------- | -------------
[**addProductImage**](ProductsApi.md#addproductimage) | **PATCH** /api/products/{product_id}/images | On Add Product Image
...
# **addProductImage**
> ProductScheme addProductImage(productId, images)
...
try {
    final response = api.addProductImage(productId, images);
    print(response);
