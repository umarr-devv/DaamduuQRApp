...
class EstablishmentsApi {
  ...
  Future<Response<EstablishmentScheme>> addEstablishmentContact({
    ...
    return Response<EstablishmentScheme>(
      data: _responseData,
  ...
  /// Returns a [Future] containing a [Response] with a [EstablishmentScheme] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EstablishmentScheme>> addEstablishmentImages({
    required String establishmentId,
    ...
    final _path = r'/api/establishments/{establishment_id}/images'.replaceAll(
      '{'
      r'establishment_id'
      '}',
      establishmentId.toString(),
  ...
  /// Returns a [Future] containing a [Response] with a [EstablishmentScheme] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EstablishmentScheme>> getEstablishment({
    required String establishmentId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  Future<Response<List<PlaceGroupScheme>>> getEstablishmentPlaceGroups({
    ...
    return Response<List<PlaceGroupScheme>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
