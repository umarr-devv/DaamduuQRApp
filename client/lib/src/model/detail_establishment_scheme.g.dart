...
part of 'detail_establishment_scheme.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

DetailEstablishmentScheme _$DetailEstablishmentSchemeFromJson(
  ...
  ($checkedConvert) {
    ...
    final val = DetailEstablishmentScheme(
      ...
      workingHours: $checkedConvert(
        'working_hours',
        (v) => (v as List<dynamic>)
            .map((e) => WorkingHourScheme.fromJson(e as Map<String, dynamic>))
            .toList(),
      ),
      placeGroups: $checkedConvert(
        'place_groups',
        (v) => (v as List<dynamic>)
            .map((e) => PlaceGroupScheme.fromJson(e as Map<String, dynamic>))
            .toList(),
      ),
...
Map<String, dynamic> _$DetailEstablishmentSchemeToJson(
  DetailEstablishmentScheme instance,
) => <String, dynamic>{
  'id': instance.id,
  ...
  'place_groups': instance.placeGroups.map((e) => e.toJson()).toList(),
