...
part 'update_place_scheme.g.dart';
...
class UpdatePlaceScheme {
  /// Returns a new [UpdatePlaceScheme] instance.
  UpdatePlaceScheme({
  ...
  final String? groupId;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is UpdatePlaceScheme &&
      other.name == name &&
      other.code == code &&
  ...
  factory UpdatePlaceScheme.fromJson(Map<String, dynamic> json) => _$UpdatePlaceSchemeFromJson(json);

  Map<String, dynamic> toJson() => _$UpdatePlaceSchemeToJson(this);
