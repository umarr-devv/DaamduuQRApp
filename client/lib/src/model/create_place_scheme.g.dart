...
part of 'create_place_scheme.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CreatePlaceScheme _$CreatePlaceSchemeFromJson(Map<String, dynamic> json) =>
    $checkedCreate(
      'CreatePlaceScheme',
      json,
      ($checkedConvert) {
...
Map<String, dynamic> _$CreatePlaceSchemeToJson(CreatePlaceScheme instance) =>
    <String, dynamic>{
      'name': instance.name,
      'code': instance.code,
