...
part 'detail_establishment_scheme.g.dart';
...
class DetailEstablishmentScheme {
  /// Returns a new [DetailEstablishmentScheme] instance.
  ...
  @JsonKey(
    ...
    name: r'working_hours',
    required: true,
    includeIfNull: false,
  )


  final List<WorkingHourScheme> workingHours;
  ...
  final List<PlaceGroupScheme> placeGroups;
  ...
  final List<PlaceScheme> places;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is DetailEstablishmentScheme &&
      other.id == id &&
    ...
    int get hashCode =>
        ...
        placeGroups.hashCode +
        places.hashCode;

  factory DetailEstablishmentScheme.fromJson(Map<String, dynamic> json) => _$DetailEstablishmentSchemeFromJson(json);

  Map<String, dynamic> toJson() => _$DetailEstablishmentSchemeToJson(this);
