...
part of 'product_scheme.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ProductScheme _$ProductSchemeFromJson(Map<String, dynamic> json) =>
    $checkedCreate(
      'ProductScheme',
      json,
      ($checkedConvert) {
...
Map<String, dynamic> _$ProductSchemeToJson(ProductScheme instance) =>
    <String, dynamic>{
      'id': instance.id,
