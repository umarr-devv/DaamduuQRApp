...
ReturnType deserialize<ReturnType, BaseType>(
  ...
  switch (targetType) {
    ...
    case 'CreateWorkingHourScheme':
      return CreateWorkingHourScheme.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    case 'CustomerScheme':
      return CustomerScheme.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    case 'DetailEstablishmentScheme':
      return DetailEstablishmentScheme.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    ...
    case 'UpdateWorkingHourScheme':
      return UpdateWorkingHourScheme.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    case 'UserScheme':
    ...
    case 'WorkingHourScheme':
      return WorkingHourScheme.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    default:
      RegExpMatch? match;
