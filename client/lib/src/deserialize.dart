...
final _regMap = RegExp(r'^Map<String,(.*)>$');
  ...
  ReturnType deserialize<ReturnType, BaseType>(dynamic value, String targetType, {bool growable= true}) {
      switch (targetType) {
        ...
        case 'CategoryScheme':
          return CategoryScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ContactScheme':
          return ContactScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ContactType':
          
          
        case 'CreateCategoryScheme':
          return CreateCategoryScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'CreateContactScheme':
          return CreateContactScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'CreateCustomerScheme':
          return CreateCustomerScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'CreateEstablishmentScheme':
          return CreateEstablishmentScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'CreateMenuScheme':
          return CreateMenuScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'CreateOrderItemScheme':
          return CreateOrderItemScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'CreateOrderScheme':
          return CreateOrderScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'CreateOrganizationScheme':
          return CreateOrganizationScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'CreatePlaceGroupScheme':
          return CreatePlaceGroupScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'CreatePlaceScheme':
          return CreatePlaceScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'CreatePlaceTypeScheme':
          return CreatePlaceTypeScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'CreatePortionScheme':
          return CreatePortionScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'CreateProductScheme':
          return CreateProductScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'CreateStoryScheme':
          return CreateStoryScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'CreateUserScheme':
          return CreateUserScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'CreateWorkingHourScheme':
          return CreateWorkingHourScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'CustomerScheme':
          return CustomerScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'DetailEstablishmentScheme':
          return DetailEstablishmentScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'DetailProductScheme':
          return DetailProductScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'EstablishmentScheme':
          return EstablishmentScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        ...
        case 'LoginUserScheme':
          return LoginUserScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'MenuAddProductScheme':
          return MenuAddProductScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'MenuDeleteProductScheme':
          return MenuDeleteProductScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'MenuScheme':
          return MenuScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'MessagingScheme':
          return MessagingScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'OrderCompleteStatus':
          
          
        case 'OrderItemScheme':
          return OrderItemScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        ...
        case 'OrganizationScheme':
          return OrganizationScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'PlaceGroupScheme':
          return PlaceGroupScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'PlacePriority':
        ...
        case 'PlaceTypeScheme':
          return PlaceTypeScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'PortionScheme':
          return PortionScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ProductScheme':
          return ProductScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'RoleType':
          
          
        case 'SearchResultScheme':
          return SearchResultScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'StoryAddEstablishmentScheme':
          return StoryAddEstablishmentScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'StoryDeleteEstablishmentScheme':
          return StoryDeleteEstablishmentScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'StoryScheme':
        ...
        case 'UpdateCategoryScheme':
          return UpdateCategoryScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'UpdateContactScheme':
          return UpdateContactScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'UpdateCustomerScheme':
          return UpdateCustomerScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'UpdateEstablishmentScheme':
          return UpdateEstablishmentScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'UpdateMenuScheme':
          return UpdateMenuScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'UpdateOrganizationScheme':
          return UpdateOrganizationScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'UpdatePlaceGroupScheme':
          return UpdatePlaceGroupScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'UpdatePlaceScheme':
          return UpdatePlaceScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'UpdatePlaceTypeScheme':
          return UpdatePlaceTypeScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'UpdatePortionScheme':
          return UpdatePortionScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'UpdateProductScheme':
          return UpdateProductScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'UpdateStoryScheme':
          return UpdateStoryScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'UpdateUserScheme':
          return UpdateUserScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'UpdateWorkingHourScheme':
          return UpdateWorkingHourScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'UserScheme':
        ...
        case 'WorkingHourScheme':
          return WorkingHourScheme.fromJson(value as Map<String, dynamic>) as ReturnType;
        default:
          RegExpMatch? match;
